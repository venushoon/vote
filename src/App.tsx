...
export default function App() {
  ...
  function saveAndMakeShareLink() {
    ...
    const { origin, pathname } = window.location;
    const link = `${origin}${pathname}?p=${token}#student`;
    setShareLink(link);
    setSaveHint("설정 저장 & 공유 링크 갱신 완료");
  }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      {viewMode === "admin" ? (
        <AdminView
          ...
          saveHint={saveHint}
          setSaveHint={setSaveHint}
          effectiveStudentLink={effectiveStudentLink}
          saveAndMakeShareLink={saveAndMakeShareLink}
        />
      ) : (
        <StudentView
          title={title}
...
type AdminProps = {
  ...
  saveHint: string;
  setSaveHint: (s: string) => void;
  effectiveStudentLink: string;
  saveAndMakeShareLink: () => void;
};
        ...
        <div className="bg-white rounded-2xl shadow p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  navigator.clipboard
                    .writeText(effectiveStudentLink)
          ...
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
            <div className="flex items-center justify-center p-3 bg-gray-50 rounded-xl border">
              <QRCode value={effectiveStudentLink} size={160} />
            </div>
